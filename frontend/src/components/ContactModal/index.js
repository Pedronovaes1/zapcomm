...
const ContactModal = ({ open, onClose, contactId, initialValues, onSave }) => {
    ...
    return (
        <div className={classes.root}>
            <Dialog open={open} onClose={handleClose} maxWidth="lg" scroll="paper" PaperProps={{ style: { borderRadius: 20,width: 'fitContent',display: "flex",justifyContent: "center",alignItems: "center", }, }}>
